module Outboxer
  module Message
    ...
    # @param messageable_type [String, nil] type of the associated object if not derived from messageable.
    # @param messageable_id [Integer, nil] ID of the associated object if not derived from messageable.
